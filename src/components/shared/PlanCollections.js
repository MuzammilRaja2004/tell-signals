...
export const Plan2 = () => {
  return (
    <div className="relative py-4 flex flex-col bg-gradient-to-r from-orange-400 to-red-500  rounded-xl shadow-2xl w-3/4 opacity-90 hover:opacity-100 hover:scale-105 transition duration-300 ease-in">
      <div className="flex flex-col  w-full  mx-6  ">
      ...
      <div className="flex flex-col mx-6 pb-2 ">
        ...
        <div className="py-5">
          <ul className="list-none list-outside text-white text-sm ">
            ...
            <li>
              Ideal for traders seeking more signals and a competitive edge.
            </li>
          </ul>
        </div>
      </div>
